...
void Sign::dataReceived()
{
  ...
  //qDebug()<<"msg [0]:"<<msg[0];
    ...
    {
        QMessageBox::information(this, tr("log in success"), tr("登录成功！"));
        this->hide();
    ...
    else if(msg.contains("*ACCEPT.",Qt::CaseSensitive))
    {
        ...
        drawer->friendsListButtons[currNum]->setIcon(QPixmap(":/images/liukanshan.jpg"));
        drawer->friendsListButtons[currNum]->setIconSize(QPixmap(":/images/liukanshan.jpg").size());
