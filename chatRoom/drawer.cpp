    ...
    :QToolBox(parent,f)
{
    ...
    SelectMapStytle->addItem(tr("默认头像"));//项目编号从0开始
    SelectMapStytle->addItem(tr("花开富贵"));
    SelectMapStytle->addItem(tr("派大星"));
     SelectMapStytle->addItem(tr("皮特"));
     SelectMapStytle->addItem(tr("懒羊羊"));
     SelectMapStytle->addItem(tr("布莱恩"));
     SelectMapStytle->addItem(tr("PP"));
    ...
    toolBtn1->setIcon(QPixmap(":/images/liukanshan.jpg"));
    toolBtn1->setIconSize(QPixmap(":/images/liukanshan.jpg").size());
...
{
    MapStytle[0]=":/images/liukanshan.jpg";
    MapStytle[1]=":/images/flower.jpg";
    MapStytle[2]=":/images/paidaxing.jpg";
    MapStytle[3]=":/images/peter.png";
   MapStytle[4]=":/images/sheep.jpg";
   MapStytle[5]=":/images/dog.jpg";
   MapStytle[6]=":/images/pp.png";
}
void Drawer::initialfriendsList()
{
    ...
    while(!friendList.isEmpty())
    {
        ...
        friendsListButtons[friendsNum]->setIcon(QPixmap(":/images/liukanshan.jpg"));
        friendsListButtons[friendsNum]->setIconSize(QPixmap(":/images/liukanshan.jpg").size());
...
void Drawer::showaddfriendWidget()
{
    if(!changefunc)
    {
        ...
        if(message.exec()==QMessageBox::Yes)
        {
            ...
            friendsListButtons[currNum]->setIcon(QPixmap(":/images/liukanshan.jpg"));
            friendsListButtons[currNum]->setIconSize(QPixmap(":/images/liukanshan.jpg").size());
